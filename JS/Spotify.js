const clientId = "jhgfdsasdfghjk09876543"; //enter your own clientId (These are just for the reference)
const clientSecret = "lkjuytreds34567890"; //enter your own clientSecret (These are just for the reference)
let i = 0;
